...
def blank_book(path: Path, *, broken: bool) -> None:
    ...
    if broken:
        ...
        sheet["C8"] = 999                           # константа вне столбца формул
        # Настоящий разрыв: формулы сверху и снизу, а между ними константа.
        sheet["E1"], sheet["E2"], sheet["E3"], sheet["E5"] = "сумма", "=B2*C2", "=B3*C3", "=SUM(E2:E4)"
        sheet["E4"] = 777                           # вот эта ячейка и есть разрыв
